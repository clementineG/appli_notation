...
use App\NotationBundle\Entity\Level;
use App\NotationBundle\Form\LevelType;
...
class LevelController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AppNotationBundle:Level')->findAll();

        return $this->render('AppNotationBundle:Level:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AppNotationBundle:Level:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppNotationBundle:Level')->find($id);
        ...
        return $this->render('AppNotationBundle:Level:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AppNotationBundle:Level:edit.html.twig', array(
            'entity'      => $entity,
